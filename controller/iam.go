...
type IAM interface {
	...
	RoleBindUserGroup(userGroupID, roleName string) (err error)                                                                              // RoleBindUserGroup allows the user system to bind a user group to a role.
	RoleUnBindUserGroup(userGroupID, roleName string) (err error)                                                                            // RoleUnBindUserGroup allows the user system to unbind a user group to a role.
	...
	AccessControlGrantToUserGroup(name, userGroupID string) (err error)                                                                      // AccessControlGrantToUserGroup allows the user system to grant access control to user group.
	AccessControlRevokeFromUserGroup(name, userGroupID string) (err error)                                                                   // AccessControlRevokeFromUserGroup allows the user system to cancel granted access control of user group.
	...
	UserGroupPermissionQuery(userGroupID string) (userGroupPermission []string, inheritedFromRole map[string][]string, err error)            // UserGroupPermissionQuery allows the user system to query identity and access control of a user group.
