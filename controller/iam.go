...
type IAM interface {
	...
	Login(sysType, username string, password []byte, entity *EntityBaseInfo) (needMFAVerify bool, qrImg, secret, accessToken, refreshToken string, err error) // Login allows the user system to  login.
	...
	MFALoginVerify(sysType, username string, mfaCode int32, mfaType string) (accessToken, refreshToken string, err error)                                     // MFALoginVerify allows the user system to perform Multi-Factor Authentication while login.
